...
export const TRAILER_ENDPOINT = 'https://api.themoviedb.org/3/movie/videos';
export const TELEVISION_AIRING_TODAY_ENDPOINT = 'https://api.themoviedb.org/3/tv/airing_today';
export const TELEVISION_SEASONS_ENDPOINT = 'https://api.themoviedb.org/3/tv/season';
